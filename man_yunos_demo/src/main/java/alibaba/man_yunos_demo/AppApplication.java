...
import com.alibaba.sdk.yunos.man.util.MANLog;
...
public class AppApplication extends Application {
    ...
    public void onCreate() {
        ...
        if (manService.getMANAnalytics().init(this, getApplicationContext())) {
            Log.d("ManYunOSDemo", "Man Init success.");
        } else {
            Log.e("ManYunOSDemo", "Man Init failed.");
        }
